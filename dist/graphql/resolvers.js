...
exports.resolvers = {
    ...
    Product: {
        customers: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return orders.map((order) => __awaiter(void 0, void 0, void 0, function* () {
                return yield customer_controller_1.default.getCustomerById(order.customerId.toString());
            }));
        })
    },
    Customer: {
        products: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return orders.map((order) => __awaiter(void 0, void 0, void 0, function* () {
                return yield product_controller_1.default.getProductById(order.productId.toString());
            }));
        })
    },
    Order: {
        product: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            return yield product_controller_1.default.getProductById(parent.productId.toString());
        }),
        customer: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            return yield customer_controller_1.default.getCustomerById(parent.customerId.toString());
        })
    },
    Mutation: {
